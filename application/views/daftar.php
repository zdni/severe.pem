                  ...
                  <div class="auth-form">
                    ...
                    <form action="<?= base_url('auth/register') ?>" method="post">
                      ...
                      <div class="form-group">
                        ...
                        <input type="password" class="form-control" name="confirm_password" id="confirm_password" placeholder="Masukkan Konfirmasi Password" required>
                      </div>
                      <div class="text-center">
                        <button type="submit" class="btn btn-primary btn-block">Daftar</button>
                        <a href="<?= base_url('auth/login') ?>" class="btn btn-default btn-block">Masuk</a>
                      </div>
                    </form>
                  </div>
                </div>
